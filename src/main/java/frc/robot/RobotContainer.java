...
//    private final Camera rearCamera;
    ...
    public RobotContainer() {
        ...
        frontCamera = new Camera(true, CameraConfig.FrontCam.cameraProperty, ObjectType.APRIL_TAG_FRONT);

//        rearCamera = new Camera(true, CameraConfig.BackCam.cameraProperty, ObjectType.APRIL_TAG_BACK);
